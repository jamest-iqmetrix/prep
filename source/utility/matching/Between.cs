...
namespace code.utility.matching
{
  ...
  {
    public static ReturnType between<Item, Property, ReturnType>(
      this IProvideAccessToMatchBuilders<Item, Property, ReturnType> extension_point, Property start, Property end)
